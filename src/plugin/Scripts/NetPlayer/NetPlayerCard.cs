    ...
    public class NetPlayerCard : MonoBehaviour
    {
        ...
        public void Resize(float cardHeight)
        {
            ...
            if (healthBar != null)
            {
                ...
                if (healthBarRect != null) healthBarRect.anchoredPosition = new Vector2(0, -iconSize - spacing - nameTextHeight - spacing);
            ...
            if (shieldBar != null)
            {
                ...
                if (shieldBarRect != null) shieldBarRect.anchoredPosition = new Vector2(iconSize + spacing, -iconSize - spacing - nameTextHeight - spacing);
